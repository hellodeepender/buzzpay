...
const sources: RecommendationSource[] = [
  {
    ...
    ctaLabel: "Business banking next step",
    envVarName: "AFFILIATE_BUSINESS_BANKING_URL",
    fallbackHref: "/go/business-banking",
  },
  {
    name: "Bookkeeping",
    ...
    ctaLabel: "Learn what to look for",
    envVarName: "AFFILIATE_BOOKKEEPING_URL",
    fallbackHref: "/go/bookkeeping",
  },
  {
    name: "Payroll",
    category: "payroll",
    ...
    ctaLabel: "Compare payroll options",
    envVarName: "AFFILIATE_PAYROLL_URL",
    fallbackHref: "/go/payroll",
  },
  {
  ...
  },
  {
    ...
    ctaLabel: "Review coverage options",
    envVarName: "AFFILIATE_INSURANCE_URL",
    fallbackHref: "/go/insurance",
  },
];
